<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Equipment_Search.aspx.cs" Inherits="EMS201724112128.Employee_CRUD" %>
                        ...
                        <ContentTemplate>
                            ...
                            <div class="card-group">
                                请选择查询选项：<asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" CssClass="form-control" DataTextField="DepartmentName" DataValueField="DepartmentName">
                                    ...
                                    <asp:ListItem>购买日期</asp:ListItem>
                                    <asp:ListItem>存放位置</asp:ListItem>
                                    <asp:ListItem>设备负责人</asp:ListItem>
